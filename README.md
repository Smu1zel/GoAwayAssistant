...
This is a fairly simple module. Simply install it as normal, reboot, and you will find that the Assistant Go app is now missing. If you want extra verification, try using ``cmd install-existing com.google.android.apps.assistant`` in an adb or local shell. If this command fails. the module worked. 
